...
| `src/main.cpp` | game loop: pooled wall entities (recycled, never destroyed), 7 point lights tracking the nearest live ceiling panels, flashlight (spot light), pause menu (ImGui via `config.gui`), head bob, mouse look |
